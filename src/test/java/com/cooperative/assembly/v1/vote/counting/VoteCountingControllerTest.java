...
public class VoteCountingControllerTest {
    ...
    public void setup() {
        ...
        this.canvass = new VotingSessionCanvass(canvassId, agendaTitle, totalVotes, affirmativeVotes, negativeVotes, session);
    ...
    public void shouldReturnOpenedVotingSessionWithGeneratedUUIDAndPeriodTimesAndApprovedByVotes() throws Exception {
        ...
        result.andDo(MockMvcResultHandlers.print())
                ...
                .andExpect(jsonPath("$.data.status").value(VoteCountingStatus.APPROVED.toString()))
    ...
    public void shouldReturnOpenedVotingSessionWithGeneratedUUIDAndTimePeriodAndRejectedByVotes() throws Exception {
        ...
        result.andDo(MockMvcResultHandlers.print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.agenda").value(agendaTitle))
                .andExpect(jsonPath("$.data.status").value(VoteCountingStatus.REJECTED.toString()))
